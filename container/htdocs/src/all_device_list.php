...
-->
        <div class="button-container" style="text-align: right;">
            <a href="?do=all_device_add" class="btn btn-primary fw-bold" style="margin-right:20%; font-size: clamp(14px, 0.8vw, 30px);">端末追加</a>
        </div>
    </div>
</div>
...
while ($row = $rs->fetch_assoc()) {
    ...
    echo "<tr><td>";
    echo '<a href="?do=all_device_detail&did='.$device_id.'">'.$device_name.'</a>';
    echo "</td></tr>";
}
